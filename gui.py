...
class App(tk.Frame):
    ...
    def __init__(self, master=None):
        ...
        self.search_button_image = Image.open(str(pathlib.Path(__file__).parent.absolute()) +"/images/search_button2.png")
        ...
        self.steam_label = tk.Label(self, font="bold")
        self.instnat_label = tk.Label(self, font="bold")
        self.g2a_label = tk.Label(self, font="bold")
        self.uplay_label = tk.Label(self, font="bold")

        self.steam1 = tk.Message(self, justify="center")

        self.instant1 = tk.Message(self, justify="center")

        self.g2a1 = tk.Message(self, justify="center")

        self.uplay = tk.Message(self, justify="center")
    ...
    def create_widgets(self):
        ...
        self.title.grid(columnspan=2, sticky="W", padx=10 )
        self.info_button.grid(row=0, column=3, sticky="E")
        self.label1.grid(row=1, column=0, sticky="E", padx=20)
        ...
        self.steam_label.grid(row=4, column=1 , pady=7)
        self.instnat_label.grid(row=4, column=0, pady=7)
        self.g2a_label.grid(row=4, column=2, pady=7)
        self.uplay_label.grid(row=4, column=3, pady=7)

        self.uplay.grid(row=5, column=3, sticky="N")
        self.steam1.grid(row=5, column=1, sticky="N")
